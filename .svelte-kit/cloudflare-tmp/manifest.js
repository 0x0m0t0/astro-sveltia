...
return {
	...
	_: {
		...
		prerendered_routes: new Set(["/","/__data.json","/info","/info/__data.json","/log","/now","/now/__data.json"]),
		matchers: async () => {
...
export const prerendered = new Set(["/","/__data.json","/info","/info/__data.json","/log","/now","/now/__data.json"]);
